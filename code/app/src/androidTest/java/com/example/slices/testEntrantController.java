...
public class testEntrantController {
            ...
            public void onSuccess() {
                EntrantController.getEntrant(entrant.getId(), new EntrantCallback() {
                    ...
                    public void onSuccess(Entrant result) {
                        assertEquals(entrant.getProfile().getName(), result.getProfile().getName());
                        latch.countDown();
                    }
    ...
    public void testGetEntrantByDeviceId() throws InterruptedException {
        ...
        EntrantController.writeEntrantDeviceId(entrant, new DBWriteCallback() {
            @Override
            public void onSuccess() {
                EntrantController.getEntrantByDeviceId(entrant.getDeviceId(), new EntrantCallback() {
                    @Override
                    public void onSuccess(Entrant result) {
    ...
    public void testUpdateEntrant() throws InterruptedException {
        ...
        EntrantController.writeEntrant(entrant, new DBWriteCallback() {
            @Override
            public void onSuccess() {
                entrant.getProfile().updateName("Updated Name", new DBWriteCallback() {
                    @Override
                    public void onSuccess() {
                        EntrantController.getEntrant(entrant.getId(), new EntrantCallback() {
                            @Override
                            public void onSuccess(Entrant result) {
                                assertEquals("Updated Name", result.getProfile().getName());
                                latch.countDown();
                            }
